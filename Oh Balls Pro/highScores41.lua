...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level41", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl41FirstTime.txt")
savedSecondTime = loadTextFile("lvl41SecondTime.txt")
savedThirdTime = loadTextFile("lvl41ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl41FirstName.txt")
savedSecondName = loadTextFile("lvl41SecondName.txt")
savedThirdName = loadTextFile("lvl41ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 41", 0, 0, "Helvetica", 27 )
	title.x = 240
