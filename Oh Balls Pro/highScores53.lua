...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level53", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl53FirstTime.txt")
savedSecondTime = loadTextFile("lvl53SecondTime.txt")
savedThirdTime = loadTextFile("lvl53ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl53FirstName.txt")
savedSecondName = loadTextFile("lvl53SecondName.txt")
savedThirdName = loadTextFile("lvl53ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 53", 0, 0, "Helvetica", 27 )
	title.x = 240
