...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level20", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl20FirstTime.txt")
savedSecondTime = loadTextFile("lvl20SecondTime.txt")
savedThirdTime = loadTextFile("lvl20ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl20FirstName.txt")
savedSecondName = loadTextFile("lvl20SecondName.txt")
savedThirdName = loadTextFile("lvl20ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 20", 0, 0, "Helvetica", 27 )
	title.x = 240
