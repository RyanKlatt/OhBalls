...
local function buttonStart(event)
	redTriangle:applyTorque( 2000 )
	whiteTriangle:applyTorque( 2000 )
	whiteTriangle2:applyTorque( -2000 )
	physics.setGravity(7, -3)
	physics.start()
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 10, 235
	...
	blueRedTarget.x, blueRedTarget.y = 10, 235
	...
	greenTarget.x, greenTarget.y = 395, 225
	...
	blueBall.gravityScale = -0.4
	group:insert( blueBall )
	
		-- make a ball
	greenBall = display.newCircle( 170, 225, 8)
	...
	redTriangle = display.newImageRect( "redTriangle.png", 80, 80)
	redTriangle.x, redTriangle.y = 220, 180
	redTriangle.rotation = 0
	redTriangleShape = { 0,-45, 40,25, -40,25 }
	physics.addBody( redTriangle, { density= 10, friction=0.1, bounce=0.5, shape=redTriangleShape } )
	redTriangle.gravityScale = 0.01
	group:insert( redTriangle )
	
	whiteTriangle = display.newImageRect( "whiteTriangle.png", 80, 80)
	whiteTriangle.x, whiteTriangle.y = 390, 50
	...
	whiteTriangle.gravityScale = 0.01
	whiteTriangle.isBullet = true
	whiteTriangle:addEventListener( "touch", onTouch )
	group:insert( whiteTriangle )
	
	whiteTriangle2 = display.newImageRect( "whiteTriangle.png", 80, 80)
	whiteTriangle2.x, whiteTriangle2.y = 210, 50
	whiteTriangle2.rotation = 0
	whiteTriangle2Shape = { 0,-45, 40,25, -40,25 }
	physics.addBody( whiteTriangle2, { density= 10, friction=0.1, bounce=0.5, shape=whiteTriangle2Shape } )
	whiteTriangle2.gravityScale = -0.01
	whiteTriangle2.isBullet = true
	whiteTriangle2:addEventListener( "touch", onTouch )
	group:insert( whiteTriangle2 )
