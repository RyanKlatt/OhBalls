...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level56", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl56FirstTime.txt")
savedSecondTime = loadTextFile("lvl56SecondTime.txt")
savedThirdTime = loadTextFile("lvl56ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl56FirstName.txt")
savedSecondName = loadTextFile("lvl56SecondName.txt")
savedThirdName = loadTextFile("lvl56ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 56", 0, 0, "Helvetica", 27 )
	title.x = 240
