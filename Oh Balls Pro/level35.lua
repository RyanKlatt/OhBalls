...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 120, 50
	...
	blueRedTarget.x, blueRedTarget.y = 120, 50
	...
	greenTarget.x, greenTarget.y = 200, 220
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 350, 10, 8)
	...
	local levelPart7 = display.newRect( 100, 60, 90, 20)
	levelPart7:setFillColor( 255, 255, 255)
	levelPart7.rotation = 90
	physics.addBody( levelPart7, { density=1.0, friction=0.5, bounce=0.1} )
	...
	physics.addBody( whiteBall, "static", { density=10.0, friction=0.5, bounce=0, radius=20 } )
