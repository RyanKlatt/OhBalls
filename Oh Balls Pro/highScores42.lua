...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level42", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl42FirstTime.txt")
savedSecondTime = loadTextFile("lvl42SecondTime.txt")
savedThirdTime = loadTextFile("lvl42ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl42FirstName.txt")
savedSecondName = loadTextFile("lvl42SecondName.txt")
savedThirdName = loadTextFile("lvl42ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 42", 0, 0, "Helvetica", 27 )
	title.x = 240
