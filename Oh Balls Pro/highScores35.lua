...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level35", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl35FirstTime.txt")
savedSecondTime = loadTextFile("lvl35SecondTime.txt")
savedThirdTime = loadTextFile("lvl35ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl35FirstName.txt")
savedSecondName = loadTextFile("lvl35SecondName.txt")
savedThirdName = loadTextFile("lvl35ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 35", 0, 0, "Helvetica", 27 )
	title.x = 240
