...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level14", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl14FirstTime.txt")
savedSecondTime = loadTextFile("lvl14SecondTime.txt")
savedThirdTime = loadTextFile("lvl14ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl14FirstName.txt")
savedSecondName = loadTextFile("lvl14SecondName.txt")
savedThirdName = loadTextFile("lvl14ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 14", 0, 0, "Helvetica", 27 )
	title.x = 240
