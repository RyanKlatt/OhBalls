...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level19", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl19FirstTime.txt")
savedSecondTime = loadTextFile("lvl19SecondTime.txt")
savedThirdTime = loadTextFile("lvl19ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl19FirstName.txt")
savedSecondName = loadTextFile("lvl19SecondName.txt")
savedThirdName = loadTextFile("lvl19ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 19", 0, 0, "Helvetica", 27 )
	title.x = 240
