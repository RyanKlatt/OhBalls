...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 20, 10
	...
	blueRedTarget.x, blueRedTarget.y = 20, 10
	...
	greenTarget.x, greenTarget.y = 400, 230
	...
	blueBall.gravityScale = 0
	blueBall.isBullet = true
	group:insert( blueBall )
	
		-- make a ball
	greenBall = display.newCircle( 10, 235, 8)
	...
	local staticPart2 = display.newImageRect( "staticPart1.png", 250, 15 )
	staticPart2.x, staticPart2.y = 240, 170
