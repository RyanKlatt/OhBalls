...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level50", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl50FirstTime.txt")
savedSecondTime = loadTextFile("lvl50SecondTime.txt")
savedThirdTime = loadTextFile("lvl50ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl50FirstName.txt")
savedSecondName = loadTextFile("lvl50SecondName.txt")
savedThirdName = loadTextFile("lvl50ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 50", 0, 0, "Helvetica", 27 )
	title.x = 240
