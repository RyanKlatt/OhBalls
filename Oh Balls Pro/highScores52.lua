...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level52", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl52FirstTime.txt")
savedSecondTime = loadTextFile("lvl52SecondTime.txt")
savedThirdTime = loadTextFile("lvl52ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl52FirstName.txt")
savedSecondName = loadTextFile("lvl52SecondName.txt")
savedThirdName = loadTextFile("lvl52ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 52", 0, 0, "Helvetica", 27 )
	title.x = 240
