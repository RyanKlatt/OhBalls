...
1, 1, 1, 1, 1   -- 3 means level is completed
}
...
function scene:createScene( event )
	...
	moreBtn.destination = "levelSelect2"
	moreBtn:addEventListener("tap", buttonHit)
	group:insert(moreBtn)
	
	local levels3Btn = display.newImageRect( "levels31_45.png", 50, 50 )
	levels3Btn.x = display.screenOriginX + 150
	levels3Btn.y = display.contentHeight - 30
	levels3Btn.destination = "levelSelect3"
	levels3Btn:addEventListener("tap", buttonHit)
	group:insert(levels3Btn)
	
	local levels4Btn = display.newImageRect( "levels46_60.png", 50, 50 )
	levels4Btn.x = display.screenOriginX + 210
	levels4Btn.y = display.contentHeight - 30
	levels4Btn.destination = "levelSelect4"
	levels4Btn:addEventListener("tap", buttonHit)
	group:insert(levels4Btn)
