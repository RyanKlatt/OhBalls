...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level54", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl54FirstTime.txt")
savedSecondTime = loadTextFile("lvl54SecondTime.txt")
savedThirdTime = loadTextFile("lvl54ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl54FirstName.txt")
savedSecondName = loadTextFile("lvl54SecondName.txt")
savedThirdName = loadTextFile("lvl54ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 54", 0, 0, "Helvetica", 27 )
	title.x = 240
