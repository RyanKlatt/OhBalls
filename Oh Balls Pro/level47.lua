...
local function buttonStart(event)
	levelPart2:applyForce( 2000, 0, levelPart2.x, levelPart2.y )
...
function scene:createScene( event )
	...
	greenTarget.x, greenTarget.y = 400, 30
	...
	greenRedTarget.x, greenRedTarget.y = 400, 30
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 240, 130, 8)
	...
	local staticPart = display.newImageRect( "staticPart1.png", 70, 175 )
	staticPart.x, staticPart.y = 130, 80
	staticPart.rotation = 90
	physics.addBody( staticPart, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart )
	
	local staticPart1 = display.newImageRect( "staticPart1.png", 70, 175 )
	staticPart1.x, staticPart1.y = 130, 185
	staticPart1.rotation = 90
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart1 )
	
	local staticPart2 = display.newImageRect( "staticPart1.png", 70, 175 )
	staticPart2.x, staticPart2.y = 350, 80
	staticPart2.rotation = 90
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart2 )
	
	local staticPart3 = display.newImageRect( "staticPart1.png", 70, 175 )
	staticPart3.x, staticPart3.y = 350, 185
