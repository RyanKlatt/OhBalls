...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level7", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl7FirstTime.txt")
savedSecondTime = loadTextFile("lvl7SecondTime.txt")
savedThirdTime = loadTextFile("lvl7ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl7FirstName.txt")
savedSecondName = loadTextFile("lvl7SecondName.txt")
savedThirdName = loadTextFile("lvl7ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 7", 0, 0, "Helvetica", 27 )
	title.x = 240
