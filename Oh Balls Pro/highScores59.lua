...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level59", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl59FirstTime.txt")
savedSecondTime = loadTextFile("lvl59SecondTime.txt")
savedThirdTime = loadTextFile("lvl59ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl59FirstName.txt")
savedSecondName = loadTextFile("lvl59SecondName.txt")
savedThirdName = loadTextFile("lvl59ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 59", 0, 0, "Helvetica", 27 )
	title.x = 240
