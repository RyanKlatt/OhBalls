...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level17", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl17FirstTime.txt")
savedSecondTime = loadTextFile("lvl17SecondTime.txt")
savedThirdTime = loadTextFile("lvl17ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl17FirstName.txt")
savedSecondName = loadTextFile("lvl17SecondName.txt")
savedThirdName = loadTextFile("lvl17ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 17", 0, 0, "Helvetica", 27 )
	title.x = 240
