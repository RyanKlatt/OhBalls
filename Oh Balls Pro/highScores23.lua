...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level23", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl23FirstTime.txt")
savedSecondTime = loadTextFile("lvl23SecondTime.txt")
savedThirdTime = loadTextFile("lvl23ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl23FirstName.txt")
savedSecondName = loadTextFile("lvl23SecondName.txt")
savedThirdName = loadTextFile("lvl23ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 23", 0, 0, "Helvetica", 27 )
	title.x = 240
