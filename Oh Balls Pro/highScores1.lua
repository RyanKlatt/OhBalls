...
savedFirstTime = loadTextFile("lvl1FirstTime.txt")
savedSecondTime = loadTextFile("lvl1SecondTime.txt")
savedThirdTime = loadTextFile("lvl1ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl1FirstName.txt")
savedSecondName = loadTextFile("lvl1SecondName.txt")
savedThirdName = loadTextFile("lvl1ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 1", 0, 0, "Helvetica", 27 )
	title.x = 240
