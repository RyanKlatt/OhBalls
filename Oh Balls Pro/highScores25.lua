...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level25", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl25FirstTime.txt")
savedSecondTime = loadTextFile("lvl25SecondTime.txt")
savedThirdTime = loadTextFile("lvl25ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl25FirstName.txt")
savedSecondName = loadTextFile("lvl25SecondName.txt")
savedThirdName = loadTextFile("lvl25ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 25", 0, 0, "Helvetica", 27 )
	title.x = 240
