...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 20, 75
	...
	blueRedTarget.x, blueRedTarget.y = 20, 75
	...
	greenTarget.x, greenTarget.y = 50, 40
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 220, 130, 8)
	...
	local levelPart = display.newRoundedRect( 150, 100, 100, 20, 10)
	levelPart:setFillColor( 128, 0, 0)
	levelPart.rotation = 0
	physics.addBody( levelPart, { density=10, friction=0.5, bounce=0} )
	levelPart.gravityScale = -0.3
	group:insert( levelPart )
	
	local levelPart2 = display.newRoundedRect( 200, 200, 100, 20, 10)
	levelPart2:setFillColor( 128, 0, 0)
	levelPart2.rotation = 0
	physics.addBody( levelPart2, { density=10, friction=0.5, bounce=0} )
	levelPart2.gravityScale = 0.3
	group:insert( levelPart2 )
	
	local staticPart1 = display.newImageRect( "whiteTriangle2.png", 60, 60)
	staticPart1.x, staticPart1.y = 360, 190
	staticPart1.rotation = 20
	staticPart1Shape = { 0,-35, 30,18, -30,18 }
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=1, shape=staticPart1Shape } )
