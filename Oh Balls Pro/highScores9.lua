...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level9", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl9FirstTime.txt")
savedSecondTime = loadTextFile("lvl9SecondTime.txt")
savedThirdTime = loadTextFile("lvl9ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl9FirstName.txt")
savedSecondName = loadTextFile("lvl9SecondName.txt")
savedThirdName = loadTextFile("lvl9ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 9", 0, 0, "Helvetica", 27 )
	title.x = 240
