...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level44", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl44FirstTime.txt")
savedSecondTime = loadTextFile("lvl44SecondTime.txt")
savedThirdTime = loadTextFile("lvl44ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl44FirstName.txt")
savedSecondName = loadTextFile("lvl44SecondName.txt")
savedThirdName = loadTextFile("lvl44ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 44", 0, 0, "Helvetica", 27 )
	title.x = 240
