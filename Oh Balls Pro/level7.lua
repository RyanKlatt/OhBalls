...
function scene:createScene( event )
	...
	greenTarget.x, greenTarget.y = 440, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 375, 200, 8)
	...
	staticPart3.x, staticPart3.y = 15, 210
