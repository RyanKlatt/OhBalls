...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level13", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl13FirstTime.txt")
savedSecondTime = loadTextFile("lvl13SecondTime.txt")
savedThirdTime = loadTextFile("lvl13ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl13FirstName.txt")
savedSecondName = loadTextFile("lvl13SecondName.txt")
savedThirdName = loadTextFile("lvl13ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 13", 0, 0, "Helvetica", 27 )
	title.x = 240
