...
local function buttonStart(event)
	...
	physics.start()
	redBall:applyForce( -100, -50, redBall.x, redBall.y )
	redBall4:applyForce( -50, -50, redBall4.x, redBall4.y )
	redBall2:applyForce( 50, -50, redBall2.x, redBall2.y )
	redBall3:applyForce( 100, -50, redBall3.x, redBall3.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 240, 240
	...
	blueRedTarget.x, blueRedTarget.y = 240, 240
	...
	greenTarget.x, greenTarget.y = 20, 225
	...
	blueBall.gravityScale = 0.1
	blueBall.isBullet = true
	group:insert( blueBall )
	
		-- make a ball
	greenBall = display.newCircle( 240, 55, 8)
	...
	greenBall.gravityScale = 0.3
	greenBall.isBullet = true
	group:insert( greenBall )
	
	redBall = display.newCircle( 320, 220, 10)
	redBall:setFillColor( 128, 0, 0)
	physics.addBody( redBall, { density=1.0, friction=0.5, bounce=0, radius=10 } )
	redBall.gravityScale = 0.4
	group:insert( redBall )
	
	redBall2 = display.newCircle( 160, 220, 10)
	redBall2:setFillColor( 128, 0, 0)
	physics.addBody( redBall2, { density=1.0, friction=0.5, bounce=0, radius=10 } )
	redBall2.gravityScale = 0.4
	group:insert( redBall2 )
	
	redBall3 = display.newCircle( 60, 220, 10)
	redBall3:setFillColor( 128, 0, 0)
	physics.addBody( redBall3, { density=1.0, friction=0.5, bounce=0, radius=10 } )
	redBall3.gravityScale = 0.4
	group:insert( redBall3 )
	
	redBall4 = display.newCircle( 420, 220, 10)
	redBall4:setFillColor( 128, 0, 0)
	physics.addBody( redBall4, { density=1.0, friction=0.5, bounce=0, radius=10 } )
	redBall4.gravityScale = 0.4
	group:insert( redBall4 )
	
	local accelLeft = display.newImageRect( "accelUp.png", 25, 25 )
	accelLeft.x, accelLeft.y = 130, 150
	...
	local levelPart = display.newRect( 430, 200, 50, 30)
	levelPart:setFillColor( 255, 255, 255)
	levelPart.rotation = 90
	physics.addBody( levelPart, { density=10.0, friction=0.5, bounce=0} )
	levelPart.isBullet = true
	levelPart:addEventListener( "touch", onTouch )
	group:insert( levelPart )
	
	local staticPart2 = display.newImageRect( "staticPart1.png", 30, 10 )
	staticPart2.x, staticPart2.y = 130, 220
