...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level38", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl38FirstTime.txt")
savedSecondTime = loadTextFile("lvl38SecondTime.txt")
savedThirdTime = loadTextFile("lvl38ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl38FirstName.txt")
savedSecondName = loadTextFile("lvl38SecondName.txt")
savedThirdName = loadTextFile("lvl38ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 38", 0, 0, "Helvetica", 27 )
	title.x = 240
