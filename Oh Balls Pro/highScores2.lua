...
savedFirstTime = loadTextFile("lvl2FirstTime.txt")
savedSecondTime = loadTextFile("lvl2SecondTime.txt")
savedThirdTime = loadTextFile("lvl2ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl2FirstName.txt")
savedSecondName = loadTextFile("lvl2SecondName.txt")
savedThirdName = loadTextFile("lvl2ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 2", 0, 0, "Helvetica", 27 )
	title.x = 240
