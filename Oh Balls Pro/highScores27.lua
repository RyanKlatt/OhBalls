...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level27", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl27FirstTime.txt")
savedSecondTime = loadTextFile("lvl27SecondTime.txt")
savedThirdTime = loadTextFile("lvl27ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl27FirstName.txt")
savedSecondName = loadTextFile("lvl27SecondName.txt")
savedThirdName = loadTextFile("lvl27ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 27", 0, 0, "Helvetica", 27 )
	title.x = 240
