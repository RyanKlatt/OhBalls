...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 100, 25
	...
	blueRedTarget.x, blueRedTarget.y = 100, 25
	...
	greenTarget.x, greenTarget.y = 410, 40
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 250, 235, 8)
	...
	local levelPart = display.newRect( 200, 100, 20, 20)
	...
	local smallLevelPart2 = display.newImageRect( "smallLevelPart.png", 30, 20 )
	smallLevelPart2.x, smallLevelPart2.y = 40, 180
	smallLevelPart2.rotation = 75
