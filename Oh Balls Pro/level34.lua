...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 55, 140
	...
	blueRedTarget.x, blueRedTarget.y = 55, 140
	...
	greenTarget.x, greenTarget.y = 420, 140
	...
	blueBall.gravityScale = -2
	group:insert( blueBall )
	
		-- make a ball
	greenBall = display.newCircle( 30, 60, 8)
	...
	greenBall.gravityScale = 2
	group:insert( greenBall )
	
	smallLevelPart = display.newImageRect( "smallLevelPart.png", 70, 20 )
	smallLevelPart.x, smallLevelPart.y = 185, 50
	...
	local whiteLevelPart = display.newRect( 240, 40, 70, 20)
	whiteLevelPart:setFillColor( 255, 255, 255)
	whiteLevelPart.rotation = 0
	physics.addBody( whiteLevelPart, { density=1.0, friction=0.5, bounce=0} )
	whiteLevelPart:addEventListener( "touch", onTouch )
	group:insert( whiteLevelPart )
	...
	group:insert( staticPart4 )
		...
		local staticPart = display.newImageRect( "staticPart1.png", 50, 10 )
	staticPart.x, staticPart.y = 435, 140
	staticPart.rotation = 90
	physics.addBody( staticPart, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart )
	
	local staticPart3 = display.newImageRect( "staticPart1.png", 40, 10 )
	staticPart3.x, staticPart3.y = 420, 165
	staticPart3.rotation = 180
	physics.addBody( staticPart3, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart3 )
	
	local staticPart5 = display.newImageRect( "staticPart1.png", 40, 10 )
	staticPart5.x, staticPart5.y = 420, 115
	staticPart5.rotation = 180
	physics.addBody( staticPart5, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart5 )
	
			local staticPart6 = display.newImageRect( "staticPart1.png", 50, 10 )
	staticPart6.x, staticPart6.y = 40, 140
	staticPart6.rotation = 90
	physics.addBody( staticPart6, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart6 )
	
	local staticPart7 = display.newImageRect( "staticPart1.png", 40, 10 )
	staticPart7.x, staticPart7.y = 55, 165
	staticPart7.rotation = 180
	physics.addBody( staticPart7, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart7 )
	
	local staticPart8 = display.newImageRect( "staticPart1.png", 40, 10 )
	staticPart8.x, staticPart8.y = 55, 115
	staticPart8.rotation = 180
	physics.addBody( staticPart8, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart8 )
	
	local redBall = display.newCircle( 240, 140, 30)
	redBall.strokeWidth = 5
	redBall:setStrokeColor( 128, 0, 0)
	redBall:setFillColor( 0, 0, 0)
	physics.addBody( redBall, "static", { density=10.0, friction=0.5, bounce=0, radius=30 } )
	group:insert( redBall )
	
	local redBall2 = display.newCircle( 120, 50, 10)
	...
	local redBall3 = display.newCircle( 360, 50, 10)
	redBall3.strokeWidth = 5
	redBall3:setStrokeColor( 128, 0, 0)
	redBall3:setFillColor( 0, 0, 0)
	physics.addBody( redBall3, "static", { density=10.0, friction=0.5, bounce=0, radius=10 } )
	group:insert( redBall3 )
	
	local redBall4 = display.newCircle( 120, 210, 10)
	...
	local redBall5 = display.newCircle( 360, 210, 10)
	redBall5.strokeWidth = 5
	redBall5:setStrokeColor( 128, 0, 0)
	redBall5:setFillColor( 0, 0, 0)
	physics.addBody( redBall5, "static", { density=10.0, friction=0.5, bounce=0, radius=10 } )
