...
local function buttonStart(event)
	blueTarget:applyForce( 0.2, -0.1, blueTarget.x, blueTarget.y )
	blueRedTarget:applyForce( 0.2, -0.1, blueRedTarget.x, blueRedTarget.y )
	greenTarget:applyForce( 0.2, 0.4, greenTarget.x, greenTarget.y )
	greenRedTarget:applyForce( 0.2, 0.4, greenRedTarget.x, greenRedTarget.y )
	physics.setGravity(-3, -3)
	physics.start()
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 220, 245
	...
	blueRedTarget.x, blueRedTarget.y = 220, 245
	...
	greenTarget.x, greenTarget.y = 420, 150
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 10, 10, 8)
	...
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=0.2, shape=staticPart1Shape } )
