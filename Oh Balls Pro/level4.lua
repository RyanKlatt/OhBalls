...
function scene:createScene( event )
	...
	greenTarget.x, greenTarget.y = 30, 20
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 450, 145, 8)
	...
	local staticPart1 = display.newImageRect( "staticPart2.png", 200, 200)
	staticPart1.x, staticPart1.y = 240, 130
	staticPart1.rotation = 90
	staticPart1Shape = { 0,-105, 80,48, -80,48 }
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=.2, shape=staticPart1Shape } )
	group:insert( staticPart1 )
	
	local smallLevelPart = display.newImageRect( "smallLevelPart.png", 50, 20 )
	smallLevelPart.x, smallLevelPart.y = 40, 180
	...
	smallLevelPart2.x, smallLevelPart2.y = 40, 80
	smallLevelPart2.rotation = 45
	...
	local staticPart3 = display.newImageRect( "staticPart1.png", 70, 10 )
	staticPart3.x, staticPart3.y = 80, 130
