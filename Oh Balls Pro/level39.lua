...
local function buttonStart(event)
	whiteBall:applyForce( 60, -300, whiteBall.x, whiteBall.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 340, 210
	...
	blueRedTarget.x, blueRedTarget.y = 340, 210
	...
	greenTarget.x, greenTarget.y = 235, 185
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 255, 150, 8)
	...
	greenBall:setLinearVelocity( 0, -7)
	group:insert( greenBall )
	
	whiteBall = display.newCircle( 150, 235, 15)
	...
	staticPart1.x, staticPart1.y = 390, 50
	...
	local staticPart = display.newImageRect( "staticPart1.png", 45, 10 )
	staticPart.x, staticPart.y = 295, 170
	staticPart.rotation = 0
	physics.addBody( staticPart, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart )
	
	local staticPart1 = display.newImageRect( "staticPart1.png", 65, 10 )
	staticPart1.x, staticPart1.y = 270, 150
	staticPart1.rotation = 90
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart1 )
	
	local staticPart2 = display.newImageRect( "staticPart1.png", 17, 10 )
	staticPart2.x, staticPart2.y = 260, 170
	staticPart2.rotation = 0
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart2 )
	
	local staticPart3 = display.newImageRect( "staticPart1.png", 90, 10 )
	staticPart3.x, staticPart3.y = 320, 210
	staticPart3.rotation = 90
	physics.addBody( staticPart3, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart3 )
	
	local staticPart4 = display.newImageRect( "staticPart1.png", 30, 10 )
	staticPart4.x, staticPart4.y = 250, 180
