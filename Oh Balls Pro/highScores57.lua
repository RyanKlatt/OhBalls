...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level57", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl57FirstTime.txt")
savedSecondTime = loadTextFile("lvl57SecondTime.txt")
savedThirdTime = loadTextFile("lvl57ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl57FirstName.txt")
savedSecondName = loadTextFile("lvl57SecondName.txt")
savedThirdName = loadTextFile("lvl57ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 57", 0, 0, "Helvetica", 27 )
	title.x = 240
