...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 420, 175
	...
	blueRedTarget.x, blueRedTarget.y = 420, 175
	...
	-- make a ball
	blueBall = display.newCircle( 240, 30, 8 )
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 420, 5, 8)
	...
	accelLeft.x, accelLeft.y = 400, 225
	...
	local levelPart = display.newRect( 200, 70, 100, 40)
