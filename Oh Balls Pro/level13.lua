...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 35, 235
	...
	blueRedTarget.x, blueRedTarget.y = 35, 235
	...
	greenTarget.x, greenTarget.y = 430, 235
	...
	local whiteBall = display.newCircle( 240, 210, 20)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=15, friction=0.5, bounce=0.2, radius=20 } )
