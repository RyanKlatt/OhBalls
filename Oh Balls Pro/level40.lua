...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 395, 200
	...
	blueRedTarget.x, blueRedTarget.y = 395, 200
	...
	greenTarget.x, greenTarget.y = 280, 30
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 30, 110, 8)
	...
	local whiteBall = display.newCircle( 150, 35, 20)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=50.0, friction=0.5, bounce=0.5, radius=20 } )
	whiteBall.gravityScale = 0.10
	...
	staticPart2.x, staticPart2.y = 390, 150
	staticPart2.rotation = 180
	staticPart2Shape = { 0,-35, 30,18, -30,18 }
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=0, shape=staticPart2Shape } )
	staticPart2:addEventListener( "touch", onTouch )
	group:insert( staticPart2 )
	
	local levelPart = display.newRect( 40, 200, 180, 20)
	...
	local levelPart2 = display.newRect( 80, 170, 180, 20)
