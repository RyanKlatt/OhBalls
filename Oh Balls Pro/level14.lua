...
local function onGravityCollision(event)
	...
	if collision.myName == "blueBall" then
	event.contact.isEnabled = true
	blueBall:applyLinearImpulse( 0, -2.3, blueBall.x, blueBall.y )
	end
	if collision.myName == "greenBall" then
	event.contact.isEnabled = true
	greenBall:applyLinearImpulse( 0, -2.3, greenBall.x, greenBall.y )
	end
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 400, 135
	...
	blueRedTarget.x, blueRedTarget.y = 400, 135
	...
	greenTarget.x, greenTarget.y = 35, 235
	...
	greenRedTarget.x, greenRedTarget.y = 35, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 330, 20, 8)
	...
	staticPart.x, staticPart.y = 400, 155
	...
	staticPart1.x, staticPart1.y = 380, 140
	...
	staticPart2.x, staticPart2.y = 420, 140
	...
	staticPart3.x, staticPart3.y = 220, 100
	staticPart3.rotation = 160
	physics.addBody( staticPart3, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart3 )
	
	
	local levelPart7 = display.newRect( 160, 150, 40, 15)
	levelPart7:setFillColor( 255, 255, 255)
	levelPart7.rotation = 90
	physics.addBody( levelPart7, { density=15, friction=0.5, bounce=0.1} )
	levelPart7.gravityScale = 0.10
	levelPart7.isBullet = true
