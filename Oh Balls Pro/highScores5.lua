...
savedFirstTime = loadTextFile("lvl5FirstTime.txt")
savedSecondTime = loadTextFile("lvl5SecondTime.txt")
savedThirdTime = loadTextFile("lvl5ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl5FirstName.txt")
savedSecondName = loadTextFile("lvl5SecondName.txt")
savedThirdName = loadTextFile("lvl5ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 5", 0, 0, "Helvetica", 27 )
	title.x = 240
