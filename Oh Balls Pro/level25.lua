...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 375, 220
	...
	blueRedTarget.x, blueRedTarget.y = 375, 220
	...
	greenTarget.x, greenTarget.y = 40, 235
	...
	greenRedTarget.x, greenRedTarget.y = 40, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 350, 70, 8)
	...
	local levelPart = display.newRect( 100, 200, 100, 10)
	...
	local levelPart2 = display.newRect( 300, 200, 100, 10)
	...
	local levelPart3 = display.newRect( 125, 150, 250, 10)
	...
	local whiteBall = display.newCircle( 50, 80, 25)
