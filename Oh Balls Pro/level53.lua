...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 15, 235
	...
	blueRedTarget.x, blueRedTarget.y = 15, 235
	...
	greenTarget.x, greenTarget.y = 50, 235
	...
	greenRedTarget.x, greenRedTarget.y = 50, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 130, 35, 8)
