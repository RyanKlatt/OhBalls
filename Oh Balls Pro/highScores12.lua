...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level12", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl12FirstTime.txt")
savedSecondTime = loadTextFile("lvl12SecondTime.txt")
savedThirdTime = loadTextFile("lvl12ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl12FirstName.txt")
savedSecondName = loadTextFile("lvl12SecondName.txt")
savedThirdName = loadTextFile("lvl12ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 12", 0, 0, "Helvetica", 27 )
	title.x = 240
