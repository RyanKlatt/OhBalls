...
local function onLevelSelectBtnRelease()
	...
	storyboard.gotoScene( "levelSelect3", "fade", 500 )
...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level39", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl39FirstTime.txt")
savedSecondTime = loadTextFile("lvl39SecondTime.txt")
savedThirdTime = loadTextFile("lvl39ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl39FirstName.txt")
savedSecondName = loadTextFile("lvl39SecondName.txt")
savedThirdName = loadTextFile("lvl39ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 39", 0, 0, "Helvetica", 27 )
	title.x = 240
