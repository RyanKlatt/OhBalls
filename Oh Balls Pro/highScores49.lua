...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level49", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl49FirstTime.txt")
savedSecondTime = loadTextFile("lvl49SecondTime.txt")
savedThirdTime = loadTextFile("lvl49ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl49FirstName.txt")
savedSecondName = loadTextFile("lvl49SecondName.txt")
savedThirdName = loadTextFile("lvl49ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 49", 0, 0, "Helvetica", 27 )
	title.x = 240
