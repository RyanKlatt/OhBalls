...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level26", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl26FirstTime.txt")
savedSecondTime = loadTextFile("lvl26SecondTime.txt")
savedThirdTime = loadTextFile("lvl26ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl26FirstName.txt")
savedSecondName = loadTextFile("lvl26SecondName.txt")
savedThirdName = loadTextFile("lvl26ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 26", 0, 0, "Helvetica", 27 )
	title.x = 240
