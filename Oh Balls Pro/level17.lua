...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 260, 40
	...
	blueRedTarget.x, blueRedTarget.y = 260, 40
	...
	greenTarget.x, greenTarget.y = 30, 120
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 80, 10, 8)
	...
	local whiteBall = display.newCircle( 240, 210, 12)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=15, friction=0.5, bounce=0.2, radius=12 } )
	whiteBall:addEventListener( "touch", onTouch)
	group:insert( whiteBall )
	
	local smallLevelPart2 = display.newImageRect( "smallLevelPart.png", 30, 30 )
	smallLevelPart2.x, smallLevelPart2.y = 180, 210
	smallLevelPart2.rotation = 165
	...
	local smallLevelPart3 = display.newImageRect( "smallLevelPart.png", 30, 30 )
	smallLevelPart3.x, smallLevelPart3.y = 100, 210
	smallLevelPart3.rotation = 45
	...
	local staticPart = display.newImageRect( "staticPart1.png", 40, 10 )
	staticPart.x, staticPart.y = 320, 155
	staticPart.rotation = 180
	...
	staticPart1.x, staticPart1.y = 240, 50
	staticPart1.rotation = 90
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart1 )
	
	local staticPart2 = display.newImageRect( "staticPart1.png", 40, 10 )
	staticPart2.x, staticPart2.y = 240, 100
	staticPart2.rotation = 20
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart2 )
	
	local staticPart3 = display.newImageRect( "staticPart1.png", 150, 10 )
	staticPart3.x, staticPart3.y = 120, 50
	staticPart3.rotation = 20
	physics.addBody( staticPart3, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart3 )
	
	local staticPart = display.newImageRect( "staticPart1.png", 30, 10 )
	staticPart.x, staticPart.y = 250, 65
	staticPart.rotation = 180
	physics.addBody( staticPart, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart )
