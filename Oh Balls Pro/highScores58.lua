...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level58", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl58FirstTime.txt")
savedSecondTime = loadTextFile("lvl58SecondTime.txt")
savedThirdTime = loadTextFile("lvl58ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl58FirstName.txt")
savedSecondName = loadTextFile("lvl58SecondName.txt")
savedThirdName = loadTextFile("lvl58ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 58", 0, 0, "Helvetica", 27 )
	title.x = 240
