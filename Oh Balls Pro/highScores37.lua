...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level37", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl37FirstTime.txt")
savedSecondTime = loadTextFile("lvl37SecondTime.txt")
savedThirdTime = loadTextFile("lvl37ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl37FirstName.txt")
savedSecondName = loadTextFile("lvl37SecondName.txt")
savedThirdName = loadTextFile("lvl37ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 37", 0, 0, "Helvetica", 27 )
	title.x = 240
