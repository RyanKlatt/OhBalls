...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level48", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl48FirstTime.txt")
savedSecondTime = loadTextFile("lvl48SecondTime.txt")
savedThirdTime = loadTextFile("lvl48ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl48FirstName.txt")
savedSecondName = loadTextFile("lvl48SecondName.txt")
savedThirdName = loadTextFile("lvl48ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 48", 0, 0, "Helvetica", 27 )
	title.x = 240
