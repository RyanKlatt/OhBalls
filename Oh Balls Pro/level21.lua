...
function scene:createScene( event )
	...
	greenTarget.x, greenTarget.y = 420, 30
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 320, 120, 8)
	...
	local whiteBall2 = display.newCircle( 330, 50, 25)
	whiteBall2:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall2, { density=10.0, friction=0.5, bounce=0, radius=25 } )
	...
	local levelPart2 = display.newRect( 80, 60, 120, 20)
	...
	staticPart1.x, staticPart1.y = 100, 225
	...
	staticPart2.x, staticPart2.y = 380, 225
