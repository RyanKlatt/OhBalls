...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level16", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl16FirstTime.txt")
savedSecondTime = loadTextFile("lvl16SecondTime.txt")
savedThirdTime = loadTextFile("lvl16ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl16FirstName.txt")
savedSecondName = loadTextFile("lvl16SecondName.txt")
savedThirdName = loadTextFile("lvl16ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 16", 0, 0, "Helvetica", 27 )
	title.x = 240
