...
local function buttonStart(event)
	levelPart:applyForce( -2500, -5000, levelPart.x, levelPart.y )
	levelPart2:applyTorque( 1000 )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 10, 240
	...
	blueRedTarget.x, blueRedTarget.y = 10, 240
	...
	greenTarget.x, greenTarget.y = 30, 225
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 50, 130, 8)
	...
	greenBall.gravityScale = -0.2
	group:insert( greenBall )
	
	levelPart = display.newRect( 370, 200, 70, 20)
	...
	levelPart2 = display.newRect( 140, 100, 70, 20)
	levelPart2:setFillColor( 255, 255, 255)
	physics.addBody( levelPart2, { density=10.0, friction=0.5, bounce=0} )
