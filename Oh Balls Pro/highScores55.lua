...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level55", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl55FirstTime.txt")
savedSecondTime = loadTextFile("lvl55SecondTime.txt")
savedThirdTime = loadTextFile("lvl55ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl55FirstName.txt")
savedSecondName = loadTextFile("lvl55SecondName.txt")
savedThirdName = loadTextFile("lvl55ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 55", 0, 0, "Helvetica", 27 )
	title.x = 240
