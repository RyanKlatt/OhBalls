...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level46", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl46FirstTime.txt")
savedSecondTime = loadTextFile("lvl46SecondTime.txt")
savedThirdTime = loadTextFile("lvl46ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl46FirstName.txt")
savedSecondName = loadTextFile("lvl46SecondName.txt")
savedThirdName = loadTextFile("lvl46ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 46", 0, 0, "Helvetica", 27 )
	title.x = 240
