...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level6", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl6FirstTime.txt")
savedSecondTime = loadTextFile("lvl6SecondTime.txt")
savedThirdTime = loadTextFile("lvl6ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl6FirstName.txt")
savedSecondName = loadTextFile("lvl6SecondName.txt")
savedThirdName = loadTextFile("lvl6ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 6", 0, 0, "Helvetica", 27 )
	title.x = 240
