...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level21", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl21FirstTime.txt")
savedSecondTime = loadTextFile("lvl21SecondTime.txt")
savedThirdTime = loadTextFile("lvl21ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl21FirstName.txt")
savedSecondName = loadTextFile("lvl21SecondName.txt")
savedThirdName = loadTextFile("lvl21ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 21", 0, 0, "Helvetica", 27 )
	title.x = 240
