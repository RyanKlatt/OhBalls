...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level30", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl30FirstTime.txt")
savedSecondTime = loadTextFile("lvl30SecondTime.txt")
savedThirdTime = loadTextFile("lvl30ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl30FirstName.txt")
savedSecondName = loadTextFile("lvl30SecondName.txt")
savedThirdName = loadTextFile("lvl30ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 30", 0, 0, "Helvetica", 27 )
	title.x = 240
