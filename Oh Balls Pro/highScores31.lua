...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level31", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl31FirstTime.txt")
savedSecondTime = loadTextFile("lvl31SecondTime.txt")
savedThirdTime = loadTextFile("lvl31ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl31FirstName.txt")
savedSecondName = loadTextFile("lvl31SecondName.txt")
savedThirdName = loadTextFile("lvl31ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 31", 0, 0, "Helvetica", 27 )
	title.x = 240
