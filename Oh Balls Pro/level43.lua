...
local function buttonStart(event)
	greenBall:applyForce( 60, -100, greenBall.x, greenBall.y )
	blueBall:applyForce( -40, -50, blueBall.x, blueBall.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 30, 140
	...
	blueRedTarget.x, blueRedTarget.y = 30, 140
	...
	greenTarget.x, greenTarget.y = 380, 170
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 50, 225, 8)
	...
	local redBall = display.newCircle( 240, 10, 25)
	redBall:setFillColor( 128, 0, 0)
	physics.addBody( redBall, { density=10.0, friction=0.5, bounce=0, radius=25 } )
	redBall.gravityScale = 0.4
	group:insert( redBall )
	
	local redBall2 = display.newCircle( 240, 80, 25)
	redBall2:setFillColor( 128, 0, 0)
	physics.addBody( redBall2, { density=10.0, friction=0.5, bounce=0, radius=25 } )
	redBall2.gravityScale = 0.4
	group:insert( redBall2 )
	
	local redBall3 = display.newCircle( 240, 150, 25)
	redBall3:setFillColor( 128, 0, 0)
	physics.addBody( redBall3, { density=10.0, friction=0.5, bounce=0, radius=25 } )
	redBall3.gravityScale = 0.4
	group:insert( redBall3 )
	
	local redBall4 = display.newCircle( 240, 220, 25)
	redBall4:setFillColor( 128, 0, 0)
	physics.addBody( redBall4, { density=10.0, friction=0.5, bounce=0, radius=25 } )
	redBall4.gravityScale = 0.4
	group:insert( redBall4 )
	
	local smallLevelPart = display.newImageRect( "smallLevelPart.png", 80, 15 )
	smallLevelPart.x, smallLevelPart.y = 40, 50
	...
	staticPart1.x, staticPart1.y = 320, 190
	staticPart1.rotation = 165
	staticPart1Shape = { 0,-35, 30,18, -30,18 }
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=1.2, shape=staticPart1Shape } )
	staticPart1:addEventListener( "touch", onTouch )
	group:insert( staticPart1 )
	
	local staticPart2 = display.newImageRect( "whiteTriangle2.png", 60, 60)
	staticPart2.x, staticPart2.y = 395, 40
	staticPart2.rotation = 115
	staticPart2Shape = { 0,-35, 30,18, -30,18 }
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=1.2, shape=staticPart2Shape } )
	staticPart2:addEventListener( "touch", onTouch )
