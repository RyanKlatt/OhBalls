...
local function buttonStart(event)
	greenBall:applyForce( 30, 0, greenBall.x, greenBall.y )
	blueBall:applyForce( 60, 0, blueBall.x, blueBall.y )
	levelPart:applyTorque( 3500 )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 30, 125
	...
	blueRedTarget.x, blueRedTarget.y = 30, 125
	...
	greenTarget.x, greenTarget.y = 450, 195
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 50, 25, 8)
	...
	levelPart = display.newRect( 330, 50, 70, 20)
	...
	staticPart3.x, staticPart3.y = 410, 205
