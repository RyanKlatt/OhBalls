...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 25, 165
	...
	blueRedTarget.x, blueRedTarget.y = 25, 165
	...
	greenTarget.x, greenTarget.y = 65, 220
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 400, 15, 8)
	...
	local smallLevelPart = display.newImageRect( "smallLevelPart.png", 20, 20 )
	smallLevelPart.x, smallLevelPart.y = 260, 100
	smallLevelPart.rotation = 165
	physics.addBody( smallLevelPart, "static", { density= 0.1, friction=0.1, bounce=1.2 } )
	smallLevelPart:addEventListener( "touch", onTouch )
	group:insert( smallLevelPart )
	
	local smallLevelPart2 = display.newImageRect( "smallLevelPart.png", 20, 20 )
	smallLevelPart2.x, smallLevelPart2.y = 180, 100
	smallLevelPart2.rotation = 165
	physics.addBody( smallLevelPart2, "static", { density= 0.1, friction=0.1, bounce=1.2 } )
	smallLevelPart2:addEventListener( "touch", onTouch )
	group:insert( smallLevelPart2 )
	
	local smallLevelPart3 = display.newImageRect( "smallLevelPart.png", 20, 20 )
	smallLevelPart3.x, smallLevelPart3.y = 100, 100
	smallLevelPart3.rotation = 45
	physics.addBody( smallLevelPart3, "static", { density= 0.1, friction=0.1, bounce=1.2 } )
