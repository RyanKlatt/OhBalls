...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 30, 100
	...
	blueRedTarget.x, blueRedTarget.y = 30, 100
	...
	greenTarget.x, greenTarget.y = 290, 200
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 345, 20, 8)
	...
	accelLeft.x, accelLeft.y = 365, 175
	...
	local levelPart3 = display.newRect( 200, 50, 100, 20)
	...
	local levelPart4 = display.newRect( 150, 100, 200, 20)
	levelPart4:setFillColor( 128, 0, 0)
	levelPart4.rotation = 0
	...
	staticPart2.x, staticPart2.y = 190, 225
