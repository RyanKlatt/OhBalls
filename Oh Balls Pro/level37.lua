...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 375, 50
	...
	blueRedTarget.x, blueRedTarget.y = 375, 50
	...
	greenTarget.x, greenTarget.y = 430, 220
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 20, 10, 8)
	...
	staticPart1.x, staticPart1.y = 320, 150
	...
	staticPart2.x, staticPart2.y = 395, 100
	staticPart2.rotation = 140
	...
	local staticPart3 = display.newImageRect( "whiteTriangle2.png", 60, 60)
	staticPart3.x, staticPart3.y = 240, 150
	staticPart3.rotation = 165
	staticPart3Shape = { 0,-35, 30,18, -30,18 }
	physics.addBody( staticPart3, "static" ,{ density= 0.1, friction=0.1, bounce=1.2, shape=staticPart3Shape } )
	staticPart3:addEventListener( "touch", onTouch )
	group:insert( staticPart3 )
	
	local staticPart4 = display.newImageRect( "whiteTriangle2.png", 60, 60)
	staticPart4.x, staticPart4.y = 100, 160
	staticPart4.rotation = 140
	staticPart4Shape = { 0,-35, 30,18, -30,18 }
	physics.addBody( staticPart4, "static" ,{ density= 0.1, friction=0.1, bounce=1.2, shape=staticPart4Shape } )
	staticPart4:addEventListener( "touch", onTouch )
