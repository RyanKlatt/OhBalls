...
local function buttonStart(event)
	...
	blueBall:applyForce( 60, 150, blueBall.x, blueBall.y )
	greenBall:applyForce( -40, 150, greenBall.x, greenBall.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 440, 50
	...
	blueRedTarget.x, blueRedTarget.y = 440, 50
	...
	greenTarget.x, greenTarget.y = 170, 40
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 420, 75, 8)
	...
	local staticPart2 = display.newImageRect( "staticPart1.png", 60, 15 )
	staticPart2.x, staticPart2.y = 195, 30
	...
	smallLevelPart.x, smallLevelPart.y = 240, 225
	...
	smallLevelPart2.x, smallLevelPart2.y = 240, 160
	smallLevelPart2.rotation = 160
