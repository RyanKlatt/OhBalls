...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 470, 120
	...
	blueRedTarget.x, blueRedTarget.y = 470, 120
	...
	greenTarget.x, greenTarget.y = 30, 170
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 380, 110, 8)
	...
	local whiteBall = display.newCircle( 240, 160, 16)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=10.0, friction=0.5, bounce=0, radius=16 } )
	...
	smallLevelPart2.x, smallLevelPart2.y = 200, 50
