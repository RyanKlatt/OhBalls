...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level32", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl32FirstTime.txt")
savedSecondTime = loadTextFile("lvl32SecondTime.txt")
savedThirdTime = loadTextFile("lvl32ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl32FirstName.txt")
savedSecondName = loadTextFile("lvl32SecondName.txt")
savedThirdName = loadTextFile("lvl32ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 32", 0, 0, "Helvetica", 27 )
	title.x = 240
