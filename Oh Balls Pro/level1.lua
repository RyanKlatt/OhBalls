...
function scene:createScene( event )
	...
	accelUp = display.newImageRect( "accelUp.png", 25, 25 )
	accelUp.x, accelUp.y = 390, 150
	accelUp.rotation = 0
	...
	blueTarget.x, blueTarget.y = 60, 240
	...
	blueRedTarget.x, blueRedTarget.y = 60, 240
	...
	greenTarget.x, greenTarget.y = 155, 140
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 300, 120, 8)
	...
	local howToBtn = display.newImageRect(  "howToPlayBtn.png", 50, 50 )
	howToBtn.x = display.screenOriginX + 90
	howToBtn.y = display.contentHeight  - 30
	howToBtn.destination = "howTo"
	howToBtn:addEventListener("tap",  buttonRetry)
	...
	whiteTriangle.x, whiteTriangle.y = 275, 70
