...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level36", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl36FirstTime.txt")
savedSecondTime = loadTextFile("lvl36SecondTime.txt")
savedThirdTime = loadTextFile("lvl36ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl36FirstName.txt")
savedSecondName = loadTextFile("lvl36SecondName.txt")
savedThirdName = loadTextFile("lvl36ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 36", 0, 0, "Helvetica", 27 )
	title.x = 240
