...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level45", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl45FirstTime.txt")
savedSecondTime = loadTextFile("lvl45SecondTime.txt")
savedThirdTime = loadTextFile("lvl45ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl45FirstName.txt")
savedSecondName = loadTextFile("lvl45SecondName.txt")
savedThirdName = loadTextFile("lvl45ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 45", 0, 0, "Helvetica", 27 )
	title.x = 240
