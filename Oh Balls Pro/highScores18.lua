...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level18", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl18FirstTime.txt")
savedSecondTime = loadTextFile("lvl18SecondTime.txt")
savedThirdTime = loadTextFile("lvl18ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl18FirstName.txt")
savedSecondName = loadTextFile("lvl18SecondName.txt")
savedThirdName = loadTextFile("lvl18ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 18", 0, 0, "Helvetica", 27 )
	title.x = 240
