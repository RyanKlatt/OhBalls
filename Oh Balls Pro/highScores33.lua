...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level33", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl33FirstTime.txt")
savedSecondTime = loadTextFile("lvl33SecondTime.txt")
savedThirdTime = loadTextFile("lvl33ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl33FirstName.txt")
savedSecondName = loadTextFile("lvl33SecondName.txt")
savedThirdName = loadTextFile("lvl33ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 33", 0, 0, "Helvetica", 27 )
	title.x = 240
