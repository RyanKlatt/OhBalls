...
savedFirstTime = loadTextFile("lvl4FirstTime.txt")
savedSecondTime = loadTextFile("lvl4SecondTime.txt")
savedThirdTime = loadTextFile("lvl4ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl4FirstName.txt")
savedSecondName = loadTextFile("lvl4SecondName.txt")
savedThirdName = loadTextFile("lvl4ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 4", 0, 0, "Helvetica", 27 )
	title.x = 240
