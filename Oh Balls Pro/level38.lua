...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 310, 40
	...
	blueRedTarget.x, blueRedTarget.y = 310, 40
	...
	greenTarget.x, greenTarget.y = 160, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 420, 10, 8)
	...
	local whiteBall = display.newCircle( 290, 180, 20)
	whiteBall.strokeWidth = 5
	whiteBall:setStrokeColor( 255, 255, 255)
	whiteBall:setFillColor( 0, 0, 0)
	physics.addBody( whiteBall, "static", { density=10.0, friction=0.5, bounce=1.5, radius=20 } )
	whiteBall:addEventListener( "touch", onTouch )
	group:insert( whiteBall )
	
	local whiteBall2 = display.newCircle( 230, 180, 20)
	whiteBall2.strokeWidth = 5
	whiteBall2:setStrokeColor( 255, 255, 255)
	whiteBall2:setFillColor( 0, 0, 0)
	physics.addBody( whiteBall2, "static", { density=10.0, friction=0.5, bounce=1.5, radius=20 } )
	whiteBall2:addEventListener( "touch", onTouch )
	group:insert( whiteBall2 )
	
	local staticPart1 = display.newImageRect( "staticPart1.png", 30, 10 )
	staticPart1.x, staticPart1.y = 290, 40
