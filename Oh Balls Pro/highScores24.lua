...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level24", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl24FirstTime.txt")
savedSecondTime = loadTextFile("lvl24SecondTime.txt")
savedThirdTime = loadTextFile("lvl24ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl24FirstName.txt")
savedSecondName = loadTextFile("lvl24SecondName.txt")
savedThirdName = loadTextFile("lvl24ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 24", 0, 0, "Helvetica", 27 )
	title.x = 240
