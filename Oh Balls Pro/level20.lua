...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 75, 60
	...
	blueRedTarget.x, blueRedTarget.y = 75, 60
	...
	greenTarget.x, greenTarget.y = 350, 205
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 280, 235, 8)
	...
	local smallLevelPart3 = display.newImageRect( "smallLevelPart.png", 30, 20 )
	smallLevelPart3.x, smallLevelPart3.y = 270, 100
	...
	local whiteBall = display.newCircle( 220, 100, 13)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=5, friction=0.5, bounce=0.2, radius=13 } )
	...
	staticPart3.x, staticPart3.y = 240, 215
	staticPart3.rotation = 0
	physics.addBody( staticPart3, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart3 )
	
	local staticPart = display.newImageRect( "staticPart1.png", 90, 10 )
	staticPart.x, staticPart.y = 420, 130
	staticPart.rotation = 120
	...
	accelLeft.x, accelLeft.y = 195, 245
