...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 400, 10
	...
	blueRedTarget.x, blueRedTarget.y = 400, 10
	...
	greenTarget.x, greenTarget.y = 240, 245
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 25, 180, 8)
	...
	local whiteBall = display.newCircle( 385, 195, 20)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=20.0, friction=0.5, bounce=0, radius=20 } )
	whiteBall:addEventListener( "touch", onTouch )
	group:insert( whiteBall )
	
	local whiteBall2 = display.newCircle( 240, 160, 13)
	whiteBall2:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall2, { density=20.0, friction=0.5, bounce=0, radius=13 } )
	whiteBall2:addEventListener( "touch", onTouch )
	group:insert( whiteBall2 )
	
	local levelPart = display.newRect( 240, 190, 120, 20)
	...
	local levelPart2 = display.newRect( 240, 50, 120, 20)
	levelPart2:setFillColor( 255, 255, 255)
	physics.addBody( levelPart2, { density=1.0, friction=0.5, bounce=0} )
	levelPart2:addEventListener( "touch", onTouch )
	levelPart2.isBullet = true
	group:insert( levelPart2 )
	
	local levelPart3 = display.newRect( 80, 50, 30, 35)
	levelPart3:setFillColor( 255, 255, 255)
	physics.addBody( levelPart3, { density=1.0, friction=0.5, bounce=0} )
	levelPart3:addEventListener( "touch", onTouch )
	levelPart3.isBullet = true
