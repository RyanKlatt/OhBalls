...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 200, 15
	...
	blueRedTarget.x, blueRedTarget.y = 200, 15
	...
	greenTarget.x, greenTarget.y = 300, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 250, 185, 8)
	...
	local levelPart7 = display.newRect( 285, 150, 100, 15)
	...
	accelRight.x, accelRight.y = 230, 40
	...
	smallLevelPart.x, smallLevelPart.y = 300, 100
	...
	local gravityDir = display.newImageRect( "zeroGravity.png", 90, 50)
	gravityDir.x, gravityDir.y = 375, 288
	group:insert( gravityDir )
