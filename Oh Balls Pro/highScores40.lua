...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level40", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl40FirstTime.txt")
savedSecondTime = loadTextFile("lvl40SecondTime.txt")
savedThirdTime = loadTextFile("lvl40ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl40FirstName.txt")
savedSecondName = loadTextFile("lvl40SecondName.txt")
savedThirdName = loadTextFile("lvl40ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 40", 0, 0, "Helvetica", 27 )
	title.x = 240
