...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level11", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl11FirstTime.txt")
savedSecondTime = loadTextFile("lvl11SecondTime.txt")
savedThirdTime = loadTextFile("lvl11ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl11FirstName.txt")
savedSecondName = loadTextFile("lvl11SecondName.txt")
savedThirdName = loadTextFile("lvl11ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 11", 0, 0, "Helvetica", 27 )
	title.x = 240
