...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 20, 235
	...
	blueRedTarget.x, blueRedTarget.y = 20, 235
	...
	greenTarget.x, greenTarget.y = 190, 10
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 360, 70, 8)
	...
	greenBall.gravityScale = 0
	greenBall.isBullet = true
	group:insert( greenBall )
	
	local redBall = display.newCircle( 420, 130, 25)
	redBall:setFillColor( 128, 0, 0)
	physics.addBody( redBall, { density=10.0, friction=0.5, bounce=1, radius=25 } )
	group:insert( redBall )
	
	local smallLevelPart = display.newImageRect( "smallLevelPart.png", 60, 30 )
	smallLevelPart.x, smallLevelPart.y = 240, 130
	...
	local smallLevelPart2 = display.newImageRect( "smallLevelPart.png", 60, 30 )
	smallLevelPart2.x, smallLevelPart2.y = 240, 180
	smallLevelPart2.rotation = 170
