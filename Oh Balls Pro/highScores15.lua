...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level15", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl15FirstTime.txt")
savedSecondTime = loadTextFile("lvl15SecondTime.txt")
savedThirdTime = loadTextFile("lvl15ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl15FirstName.txt")
savedSecondName = loadTextFile("lvl15SecondName.txt")
savedThirdName = loadTextFile("lvl15ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 15", 0, 0, "Helvetica", 27 )
	title.x = 240
