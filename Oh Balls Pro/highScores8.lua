...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level8", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl8FirstTime.txt")
savedSecondTime = loadTextFile("lvl8SecondTime.txt")
savedThirdTime = loadTextFile("lvl8ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl8FirstName.txt")
savedSecondName = loadTextFile("lvl8SecondName.txt")
savedThirdName = loadTextFile("lvl8ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 8", 0, 0, "Helvetica", 27 )
	title.x = 240
