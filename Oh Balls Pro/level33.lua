...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 375, 150
	...
	blueRedTarget.x, blueRedTarget.y = 375, 150
	...
	greenTarget.x, greenTarget.y = 20, 80
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 375, 20, 8)
	...
	local staticPart2 = display.newImageRect( "staticPart1.png", 60, 10 )
	staticPart2.x, staticPart2.y = 50, 70
	staticPart2.rotation = 30
	...
	accelRight.x, accelRight.y = 130, 100
	...
	local redTriangle = display.newImageRect( "redTriangle.png", 80, 80)
	redTriangle.x, redTriangle.y = 275, 70
