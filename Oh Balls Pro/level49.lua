...
local function buttonStart(event)
	blueBall:applyForce( -100, 150, blueBall.x, blueBall.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 140, 105
	...
	blueRedTarget.x, blueRedTarget.y = 140, 105
	...
	greenTarget.x, greenTarget.y = 15, 20
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 220, 220, 8)
	...
	local staticPart1 = display.newImageRect( "staticPart1.png", 170, 15 )
	staticPart1.x, staticPart1.y = 80, 90
	staticPart1.rotation = 70
	physics.addBody( staticPart1, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart1 )
	
	local staticPart2 = display.newImageRect( "staticPart1.png", 100, 15 )
	staticPart2.x, staticPart2.y = 180, 90
	staticPart2.rotation = 70
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart2 )
	
	local whiteBall = display.newCircle( 290, 80, 20)
