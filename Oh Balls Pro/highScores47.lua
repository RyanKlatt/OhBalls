...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level47", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl47FirstTime.txt")
savedSecondTime = loadTextFile("lvl47SecondTime.txt")
savedThirdTime = loadTextFile("lvl47ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl47FirstName.txt")
savedSecondName = loadTextFile("lvl47SecondName.txt")
savedThirdName = loadTextFile("lvl47ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 47", 0, 0, "Helvetica", 27 )
	title.x = 240
