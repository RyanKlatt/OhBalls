...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level29", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl29FirstTime.txt")
savedSecondTime = loadTextFile("lvl29SecondTime.txt")
savedThirdTime = loadTextFile("lvl29ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl29FirstName.txt")
savedSecondName = loadTextFile("lvl29SecondName.txt")
savedThirdName = loadTextFile("lvl29ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 29", 0, 0, "Helvetica", 27 )
	title.x = 240
