...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 25, 65
	...
	blueRedTarget.x, blueRedTarget.y = 25, 65
	...
	greenTarget.x, greenTarget.y = 420, 235
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 160, 195, 8)
	...
	local levelPart = display.newRect( 100, 210, 240, 20)
	...
	local whiteBall = display.newCircle( 375, 145, 20)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=1.0, friction=0.5, bounce=0.2, radius=20 } )
