...
savedFirstTime = loadTextFile("lvl3FirstTime.txt")
savedSecondTime = loadTextFile("lvl3SecondTime.txt")
savedThirdTime = loadTextFile("lvl3ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl3FirstName.txt")
savedSecondName = loadTextFile("lvl3SecondName.txt")
savedThirdName = loadTextFile("lvl3ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 3", 0, 0, "Helvetica", 27 )
	title.x = 240
