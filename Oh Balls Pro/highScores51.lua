...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level51", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl51FirstTime.txt")
savedSecondTime = loadTextFile("lvl51SecondTime.txt")
savedThirdTime = loadTextFile("lvl51ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl51FirstName.txt")
savedSecondName = loadTextFile("lvl51SecondName.txt")
savedThirdName = loadTextFile("lvl51ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 51", 0, 0, "Helvetica", 27 )
	title.x = 240
