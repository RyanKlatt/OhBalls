...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level10", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl10FirstTime.txt")
savedSecondTime = loadTextFile("lvl10SecondTime.txt")
savedThirdTime = loadTextFile("lvl10ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl10FirstName.txt")
savedSecondName = loadTextFile("lvl10SecondName.txt")
savedThirdName = loadTextFile("lvl10ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 10", 0, 0, "Helvetica", 27 )
	title.x = 240
