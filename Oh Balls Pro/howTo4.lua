...
local function onLearnBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "howTo5", "fade", 500 )
...
local function onBackBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "howTo3", "fade", 500 )
...
function scene:createScene( event )
	...
	local background = display.newImageRect( "howToBackground4.png", display.contentWidth, display.contentHeight*.9 )
