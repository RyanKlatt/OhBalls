...
function scene:createScene( event )
		...
		for i=0,2 do
			for j=1,5 do
				...
				levelIndex = levelIndex + 1
					local imagesId = levels3[levelIndex]
						levelImg = display.newImageRect (images3[imagesId].getFile , 45, 45 )
						levelImg.x = 45 + (j*65)
						levelImg.y  = 85+ (i*65)
						...
						if images3[imagesId].types ~= "locked" then
	...
	backBtn.destination = "levelSelect2"
	...
	moreBtn.destination = "levelSelect4"
