...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level22", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl22FirstTime.txt")
savedSecondTime = loadTextFile("lvl22SecondTime.txt")
savedThirdTime = loadTextFile("lvl22ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl22FirstName.txt")
savedSecondName = loadTextFile("lvl22SecondName.txt")
savedThirdName = loadTextFile("lvl22ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 22", 0, 0, "Helvetica", 27 )
	title.x = 240
