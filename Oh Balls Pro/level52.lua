...
local function buttonStart(event)
	...
	redBall:applyForce( -10000, 0, redBall.x, redBall.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 15, 150
	...
	blueRedTarget.x, blueRedTarget.y = 15, 150
	...
	greenTarget.x, greenTarget.y = 255, 15
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 270, 235, 8)
	...
	redBall = display.newCircle( 350, 155, 100)
	redBall:setFillColor( 128, 0, 0)
	physics.addBody( redBall, { density=10.0, friction=1, bounce=0, radius=100 } )
	group:insert( redBall )
	
	local levelPart = display.newRect( 60, 120, 50, 30)
	levelPart:setFillColor( 255, 255, 255)
	levelPart.rotation = 90
	physics.addBody( levelPart, { density=10.0, friction=1, bounce=0} )
	levelPart.isBullet = true
	levelPart:addEventListener( "touch", onTouch )
	group:insert( levelPart )
	
	local levelPart2 = display.newRect( 180, 120, 50, 30)
	levelPart2:setFillColor( 255, 255, 255)
	levelPart2.rotation = 90
	physics.addBody( levelPart2, { density=10.0, friction=1, bounce=0} )
	levelPart2.isBullet = true
	levelPart2:addEventListener( "touch", onTouch )
	group:insert( levelPart2 )

	
	local levelPart3 = display.newRect( 60, 50, 200, 20)
	levelPart3:setFillColor( 255, 255, 255)
	levelPart3.rotation = 0
	physics.addBody( levelPart3, { density=10.0, friction=1, bounce=0} )
	levelPart.isBullet = true
