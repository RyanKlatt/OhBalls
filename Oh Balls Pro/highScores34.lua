...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level34", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl34FirstTime.txt")
savedSecondTime = loadTextFile("lvl34SecondTime.txt")
savedThirdTime = loadTextFile("lvl34ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl34FirstName.txt")
savedSecondName = loadTextFile("lvl34SecondName.txt")
savedThirdName = loadTextFile("lvl34ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 34", 0, 0, "Helvetica", 27 )
	title.x = 240
