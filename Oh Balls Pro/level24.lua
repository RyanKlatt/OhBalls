...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 40, 170
	...
	blueRedTarget.x, blueRedTarget.y = 40, 170
	...
	greenTarget.x, greenTarget.y = 340, 25
	...
	smallLevelPart.x, smallLevelPart.y = 100, 100
	smallLevelPart.rotation = 50
	...
	local levelPart = display.newRect( 300, 180, 160, 20)
	...
	local whiteBall = display.newCircle( 200, 160, 25)
