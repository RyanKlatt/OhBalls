...
local function onLevelSelectBtnRelease()
	...
	storyboard.gotoScene( "levelSelect2", "fade", 500 )
...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level28", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl28FirstTime.txt")
savedSecondTime = loadTextFile("lvl28SecondTime.txt")
savedThirdTime = loadTextFile("lvl28ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl28FirstName.txt")
savedSecondName = loadTextFile("lvl28SecondName.txt")
savedThirdName = loadTextFile("lvl28ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 28", 0, 0, "Helvetica", 27 )
	title.x = 240
