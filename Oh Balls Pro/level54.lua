...
local function buttonStart(event)
	levelPart2:applyForce( 3000, 0, levelPart2.x, levelPart2.y )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 425, 235
	...
	blueRedTarget.x, blueRedTarget.y = 425, 235
	...
	greenTarget.x, greenTarget.y = 445, 140
	...
	blueBall.gravityScale = -1
	blueBall.isBullet = true
	group:insert( blueBall )
	
		-- make a ball
	greenBall = display.newCircle( 400, 35, 8)
	...
	greenBall.gravityScale = 0.6
	greenBall.isBullet = true
	group:insert( greenBall )
	
	levelPart2 = display.newRect( 240, 30, 80, 20)
	levelPart2:setFillColor( 255, 255, 255)
	levelPart2.rotation = 0
	physics.addBody( levelPart2, { density=10.0, friction=0.5, bounce=0.3} )
	levelPart2.isBullet = true
	levelPart2:addEventListener( "touch", onTouch )
	group:insert( levelPart2 )
	
	local smallLevelPart2 = display.newImageRect( "smallLevelPart.png", 70, 20 )
	smallLevelPart2.x, smallLevelPart2.y = 110, 30
	smallLevelPart2.rotation = 130
	...
	accelLeft.x, accelLeft.y = 150, 110
	...
	local staticPart2 = display.newImageRect( "staticPart1.png", 150, 10 )
	staticPart2.x, staticPart2.y = 240, 140
	staticPart2.rotation = 0
	physics.addBody( staticPart2, "static" ,{ density= 0.1, friction=0.1, bounce=.2 } )
	group:insert( staticPart2 )
	
	local levelPart = display.newRect( 200, 160, 20, 20)
	levelPart:setFillColor( 128, 0, 0)
	physics.addBody( levelPart, { density=0.9, friction=0.5, bounce=0} )
	levelPart.gravityScale = -0.8
	group:insert( levelPart )
	
	local levelPart1 = display.newRect( 260, 160, 20, 20)
	levelPart1:setFillColor( 128, 0, 0)
	levelPart1.rotation = 0
	physics.addBody( levelPart1, { density=0.9, friction=0.5, bounce=0} )
	levelPart1.gravityScale = -0.8
	group:insert( levelPart1 )
	
	local levelPart3 = display.newRect( 250, 190, 20, 20)
	levelPart3:setFillColor( 128, 0, 0)
	levelPart3.rotation = 0
	physics.addBody( levelPart3, { density=0.9, friction=0.5, bounce=0} )
	levelPart3.gravityScale = -0.8
	group:insert( levelPart3 )
	
	local levelPart4 = display.newRect( 210, 190, 20, 20)
	levelPart4:setFillColor( 128, 0, 0)
	physics.addBody( levelPart4, { density=0.9, friction=0.5, bounce=0} )
	levelPart4.gravityScale = -0.8
	group:insert( levelPart4 )
	
	local levelPart5 = display.newRect( 245, 215, 20, 20)
	levelPart5:setFillColor( 128, 0, 0)
	levelPart5.rotation = 0
	physics.addBody( levelPart5, { density=0.9, friction=0.5, bounce=0} )
	levelPart5.gravityScale = -0.8
	group:insert( levelPart5 )
	
	local levelPart6 = display.newRect( 215, 215, 20, 20)
	levelPart6:setFillColor( 128, 0, 0)
	levelPart6.rotation = 0
	physics.addBody( levelPart6, { density=0.9, friction=0.5, bounce=0} )
	levelPart6.gravityScale = -0.8
