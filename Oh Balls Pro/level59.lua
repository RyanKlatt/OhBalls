...
local function buttonStart(event)
	blueTarget:applyForce( 0.3, -0.4, blueTarget.x, blueTarget.y )
	blueRedTarget:applyForce( 0.3, -0.4, blueRedTarget.x, blueRedTarget.y )
	greenTarget:applyForce( 0, 0.1, greenTarget.x, greenTarget.y )
	greenRedTarget:applyForce( 0, 0.1, greenRedTarget.x, greenRedTarget.y )
	levelPart:applyTorque( 1500 )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 30, 225
	...
	blueRedTarget.x, blueRedTarget.y = 30, 225
	...
	greenTarget.x, greenTarget.y = 10, 55
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 300, 200, 8)
	...
	smallLevelPart.x, smallLevelPart.y = 80, 60
