...
local function buttonStart(event)
	redBall:applyTorque( 3000 )
	redBall2:applyTorque( 3000 )
	redBall3:applyTorque( 3000 )
	redBall4:applyTorque( 3000 )
...
function scene:createScene( event )
	...
	blueTarget.x, blueTarget.y = 250, 50
	...
	blueRedTarget.x, blueRedTarget.y = 250, 50
	...
	greenTarget.x, greenTarget.y = 460, 240
	...
	group:insert( blueBall )
		...
		-- make a ball
	greenBall = display.newCircle( 180, 110, 8)
	...
	local whiteBall = display.newCircle( 330, 135, 20)
	whiteBall:setFillColor( 255, 255, 255)
	physics.addBody( whiteBall, { density=60, friction=0.5, bounce=0.5, radius=20 } )
	whiteBall.gravityScale = 0.3
	whiteBall:addEventListener( "touch", onTouch )
	group:insert( whiteBall )
	
	local levelPart2 = display.newRect( 280, 30, 150, 20)
	...
	redBall = display.newCircle( 40, 200, 25)
	...
	redBall2 = display.newCircle( 90, 200, 25)
	...
	redBall3 = display.newCircle( 140, 200, 25)
	...
	redBall4 = display.newCircle( 190, 200, 25)
