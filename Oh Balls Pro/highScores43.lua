...
local function onPlayLevelBtnRelease()
	...
	-- go to level1.lua scene
	storyboard.gotoScene( "level43", "fade", 500 )
	return true	-- indicates successful touch
end
...
savedFirstTime = loadTextFile("lvl43FirstTime.txt")
savedSecondTime = loadTextFile("lvl43SecondTime.txt")
savedThirdTime = loadTextFile("lvl43ThirdTime.txt")
...
savedFirstName = loadTextFile("lvl43FirstName.txt")
savedSecondName = loadTextFile("lvl43SecondName.txt")
savedThirdName = loadTextFile("lvl43ThirdName.txt")
...
function scene:createScene( event )
	...
	local title = display.newText( "Level 43", 0, 0, "Helvetica", 27 )
	title.x = 240
